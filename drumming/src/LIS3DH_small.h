...
class Adafruit_LIS3DH_small : public Adafruit_Sensor {
 public:
  Adafruit_LIS3DH_small(void);
  Adafruit_LIS3DH_small(int8_t cspin);
  Adafruit_LIS3DH_small(int8_t cspin, int8_t mosipin, int8_t misopin, int8_t sckpin);
